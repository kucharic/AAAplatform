<?php
  ...
  if (!empty($_POST['submit']) && ($_POST['submit'] == 'yes')) {
    ...
    if (empty($_POST['username']) || ($_POST['username'] == '---')) {
      ...
      //save data to DB
      $query = "INSERT INTO radreply(username, attribute, op, value) VALUES ('".$_POST['username']."', '".$_POST['attribute']."', '".$_POST['op']."', '".$_POST['value']."' );";
...
?>
          ...
          <form class="form-horizontal" action="/radius/user/reply/add<?php if (!empty($_GET['return'])) { echo "?return=".$_GET['return']; } ?>" method="post">
            <legend>For</legend>
